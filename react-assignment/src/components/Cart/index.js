        ...
        <section className="Cart bg-gray-100 pt-4 pb-4">
                ...
                {cart.map((item, index) => (
                    <div key={index} className="my-5 flex items-center grid grid-cols-6">
                        ...
                        <div className="px-2 text-right">
                            ...
                            <input type="number" name="" min="1" className="w-12 border-2 rounded pl-2" value={item.amount} id="" />
            ...
            <div className="container mx-auto bg-white rounded mt-3 p-3">
                <div className="grid grid-cols-6 text-gray-700 rounded shadow-md p-2 text-xl items-center">
                    ...
                    <div className=""></div>
                    <div className=""></div>
                    <div className="">Total Price: <span className="text-lg text-blue-600"><NumberFormat value={10000000} displayType={'text'} thousandSeparator={true} prefix={'₫'} /></span></div>
