...
const RelateProducts = ({products}) => {
    return (
        <section className="relate-products bg-gray-100">
            <div className="container mx-auto bg-white rounded">
                <div className="text-4xl font-bold p-16 pb-10 text-center">Relate <span className="text-blue-500">Products</span></div>
